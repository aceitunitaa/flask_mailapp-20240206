...
def getmail():
   if request.method == 'POST':
      ...
      mycursor.execute("SELECT Mail FROM información WHERE Nom = %s", (nom,))
      myresult = mycursor.fetchall()
      return render_template('resultgetmail.html',nom=nom,correu=myresult)
   else:
...
def addmail():
   if request.method == 'POST':
      ...
      mycursor.execute("INSERT INTO información (Nom, Mail) VALUES (%s, %s)", (nom,correu))
